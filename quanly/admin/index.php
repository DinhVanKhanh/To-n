...
if (!$user->CheckAdmin()) $rt->LoginPage(true);
?>
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">    
                        <li>
                            <a href="?r=product&p=showlist">Danh mục sản phẩm</a>
                        </li>
                        <li>
                            <a href="?r=order&p=showlist">Đơn hàng</a>
                        </li>
                        ...
                        ?>
                        <!-- <li>
                            <a href="?r=order&p=title1&id= echo $dong['id']">Chỉnh sửa title1</a>
                        </li> -->
                        <?php } ?>
                        ...
                        ?>
                         <li>
                            <a href="?r=order&p=title2&id=<?php echo $dong['id']?>">Chỉnh sửa phần toán tư duy</a>
                        </li>
                        <?php }?>
                        <!-- select lấy id -->
                        <?php
                        ...
                        ?>
                        <li>
                            <a href="?r=order&p=footlist&id=<?php echo $dong['id'] ?>">Chỉnh sửa footer</a>
                        </li>
                        <?php }?>
                        ...
                        ?>
                        <li>
                            <a href="?r=order&p=lienhe&id=<?php echo $dong['id']?>">Chỉnh sửa liên hệ</a>
                        </li>
                        <?php }?>
                        <li>
        ...
        <div id="page-wrapper">
            <?php
            // var_dump($rt->GetGet('r'));
            if ($rt->GetGet('r') && $rt->GetGet('p')) {

                $r = $rt->GetGet('r');
                $p = $rt->GetGet('p');
                
                include($rt->GetFileInAdmin($r, $p));
            } else {
