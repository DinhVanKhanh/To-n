...
class apps_model_User
{
    ...
    public function InserUser($user_username,$user_password,$user_email,$addre,$user_type=2,$matp="")
    {
        $db = new apps_libs_Dbconn();
        ...
        $param =
            ...
            "from" => "users",
            "param" => [
                "col" => "user_username,user_password,user_email,user_type,matp,addre",
                "data" =>
                    [
                    "'" . $user_username . "'",
                    "'" . $user_password . "'",
    ...
    public function UpdateUser($user_password,$user_email,$addre)
    {
        $db = new apps_libs_Dbconn();
        $param =
            [
            ...
            "param" =>
                [
                "col" => [
                    "user_password", "user_email","addre"
                ],
                "data" =>
                    [
                    "'" . $user_password . "'",
