...
<div class="h-padding">
                ...
                <div class="col-lg-12">
                    <div class="form-group"> 
                        <div class="col-sm-12" style="padding-bottom: 20px ">
                            ...
                            <input onclick="send_ajax()" type="button" id="submit" class="btn btn-primary" value="Đặt Hàng" style="float: right;margin-top:10px" />
                        </div>
    ...
    <script>
        ...
        function send_ajax() {
            ...
            $.ajax({
                url: "order-free/list/send-order.php",
                type: "post",
                dataType: "json",
                data: {
                    submit:$('#submit').val(),
        ...
        function load_ajax(number, value = null, max = null) {
            ...
            $.ajax({
                url: "order-free/list/loaddata.php",
                type: "post",
                dataType: "text",
                data: {
                    number: number,
