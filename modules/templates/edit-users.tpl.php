...
$city = '
                    <select onchange=\'load_ajax_district()\' id="reg_city_s" name="city"><option>Chọn tỉnh/thành phố</option>
                ';
            ...
            <legend>Thông tin</legend>
                ...
                <div class="clear"></div>
                    <p>
                        ...
                        <input type="text" name="phone" id="account_phone" value="' . $userInformation['end_user_phone_number'] . '">
                    </p>   
                 ...
                 <div class="clear"></div>
                    <p>
                        <label for="account_district">Quận/Huyện</label>
                            <select onchange=\'load_ajax_ward()\' id="reg_district_s" name="district">
                ...
                <div class="clear"></div>
                    <p>
                        ...
                        <select id="reg_ward_s" name="ward">
                ...
                <p>
                    ...
                    <input type="text" name="address" id="account_address" value="' . $userInformation['end_user_address'] . '">
                </p>
